...
let serviceAccount = require("/home/tasnia/KireiKyo_Beauty/kireikyo-1c1de-firebase-adminsdk-ic3ot-2ae3526b25.json");
...
app.post('/seller',(req,res)=>{
    ...
    if(!namee.length|| !address.length || !about.length || number.length<11 || !Number(number) ){
